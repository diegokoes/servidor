...
<%
    ...
    String[] roles2 = request.getParameterValues("roles");
    List<String> roles = (roles2 != null && roles2.length > 0)
            ? List.of(roles2)
            : List.of();
%>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <select name="pais" id="pais" class="form-select">
                    ...
                    <option value="ES" selected="${param.pais.equals("ES")}">España</option>
                    <option value="MX" selected=${param.pais.equals("MX")}>México</option>
                    <option value="CL" selected=${param.pais.equals("CL")}>Chile</option>
                    <option value="AR" selected=${param.pais.equals("AR")}>Argentina</option>
                    <option value="PE" selected=${param.pais.equals("PE")}>Perú</option>
                    <option value="CO" selected=${param.pais.equals("CO")}>Colombia</option>
                    <option value="VE" selected=${param.pais.equals("VE")}>Venezuela</option>
                </select>
            </div>
            <%
