...
<form action="productos/ver" method="GET" target="#">
    <fieldset class="fieldset-principal">
        ...
        <p><input type="submit"
                  value="Obtener listado de productos en formato tabla"/></p>
    </fieldset>
</form>
...
<form action="productos/modificar" method="POST" target="#">
    <fieldset class="fieldset-principal">
        ...
        <label for="nombre">Nombre:<input type="text" name="nombre"
                                          id="nombre"/></label>
        <label for="precio">Precio:<input type="text" name="precio"
                                          id="precio"/></label>
        <!-- <p>
    ...
    <fieldset class="fieldset-principal">
        ...
        <label for="operacion1">Insertar nuevo producto con todos los
            campos:<input type="radio" value="insert" id="operacion1"
                          name="operacion" required/></label>
        <label for="operacion2">Actualizar nombre del producto:<input
                type="radio" name="operacion" id="operacion2" value="update"
                required/></label>
        <label for="operacion3">Borrar por código de producto:<input
                type="radio" name="operacion" id="operacion3" value="delete"
                required/></label>
        <label for="codigo">Código del producto (actualizar/borrar):<input
                type="text" name="codigo" id="codigo"/></label>
