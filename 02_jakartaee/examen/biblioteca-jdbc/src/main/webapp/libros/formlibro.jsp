    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card form-card">
              ...
              <form method="post"
                  action="<%= request.getContextPath() %><%= (request.getAttribute("libroEditar") != null) ? "/libros/editar" : "/libros/crear" %>">
                        <div class="mb-3">
                            <label for="libroId" class="form-label">ID (solo
                                lectura)</label>
                            <%
                            ...
                            %>
                            <input type="text" class="form-control" id="libroId"
                                   name="libroId" value="<%= libroIdVal %>"
                                   readonly/>
                        </div>
                        <div class="mb-3">
                            <label for="titulo"
                            ...
                            <input type="text" class="form-control" id="titulo"
                                   name="titulo"
                                   value="<%= (libroEditar != null && libroEditar.getTitulo()!=null) ? libroEditar.getTitulo() : "" %>"
                                   required/>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="autor" name="autor"
                                ...
                                %>
                                <option value="<%= a.getId_autor() %>" <%= (autorSel != null && autorSel.equals(a.getId_autor())) ? "selected" : "" %>><%= a.getNombre() %>
                                </option>
                                <%
                                        }
                                    }
                        ...
                        <div class="mb-3">
                            <label for="fechaPublicacion" class="form-label">Fecha
                            ...
                            <%
                                ...
                                if (libroEditar != null && libroEditar.getFechaPublicacion() != null) {
                                    ...
                                    fechaVal = iso.format(libroEditar.getFechaPublicacion());
                                }
                            %>
                            <input type="date" class="form-control"
                                   id="fechaPublicacion" name="fechaPublicacion"
                                   value="<%= fechaVal %>"/>
                        </div>
